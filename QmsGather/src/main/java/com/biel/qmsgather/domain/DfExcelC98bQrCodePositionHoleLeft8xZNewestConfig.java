 ...
 * @TableName df_excel_c98b_qr_code_position_hole_left_8x_z_newest_config
 */
@TableName(value ="df_excel_c98b_qr_code_position_hole_left_8x_z_newest_config")
@Data
public class DfExcelC98bQrCodePositionHoleLeft8xZNewestConfig implements Serializable {
