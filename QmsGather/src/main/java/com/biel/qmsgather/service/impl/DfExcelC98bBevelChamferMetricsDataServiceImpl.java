...
/**
* @author 96901
* @description 针对表【df_excel_c98b_bevel_chamfer_metrics_data】的数据库操作Service实现
* @createDate 2025-02-12 11:55:06
*/
@Service
@Slf4j
public class DfExcelC98bBevelChamferMetricsDataServiceImpl extends ServiceImpl<DfExcelC98bBevelChamferMetricsDataMapper, DfExcelC98bBevelChamferMetricsData>
    implements DfExcelC98bBevelChamferMetricsDataService{
