...
import com.biel.qmsgather.domain.DfExcelC98bInkBm2Config01;
import com.biel.qmsgather.mapper.DfExcelC98bInkBm2Config01Mapper;
import com.biel.qmsgather.service.DfExcelC98bInkBm2Config01Service;
...
/**
* @author 96901
* @description 针对表【df_excel_c98b_ink_bm2_config_01】的数据库操作Service实现
* @createDate 2025-02-21 10:02:54
*/
@Slf4j
@Service
public class DfExcelC98bInkBm2Config01ServiceImpl extends ServiceImpl<DfExcelC98bInkBm2Config01Mapper, DfExcelC98bInkBm2Config01>
    implements DfExcelC98bInkBm2Config01Service{


    @Autowired
    private DfExcelC98bInkBm2Config01Mapper mapper;

    public int importConfigFromExcel(MultipartFile file,String batchId) {
        log.info("开始读取Excel文件...");
        List<DfExcelC98bInkBm2Config01> dataList = new ArrayList<>();
        ...
        try {
            ...
            try {
                ...
                // 创建实体对象
                DfExcelC98bInkBm2Config01 config = new DfExcelC98bInkBm2Config01();
    ...
    public int batchSaveConfig(List<DfExcelC98bInkBm2Config01> dataList) {
        if (dataList.isEmpty()) {
            return 0;
        }
        ...
        for (DfExcelC98bInkBm2Config01 data : dataList) {
            try {
                mapper.insert(data);
                successCount++;
    ...
    private boolean isValidConfigData(DfExcelC98bInkBm2Config01 data) {
