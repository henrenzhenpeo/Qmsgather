...
import com.biel.qmsgather.domain.DfExcelC98bInkBm3andoilConfig01;
import com.biel.qmsgather.mapper.DfExcelC98bInkBm3Config01Mapper;
import com.biel.qmsgather.mapper.DfExcelC98bInkBm3andoilConfig01Mapper;
import com.biel.qmsgather.service.DfExcelC98bInkBm3andoilConfig01Service;
...
/**
* @author 96901
* @description 针对表【df_excel_c98b_ink_bm3andoil_config_01】的数据库操作Service实现
* @createDate 2025-02-21 10:03:02
*/
@Service
@Slf4j
public class DfExcelC98bInkBm3andoilConfig01ServiceImpl extends ServiceImpl<DfExcelC98bInkBm3andoilConfig01Mapper, DfExcelC98bInkBm3andoilConfig01>
    implements DfExcelC98bInkBm3andoilConfig01Service{




    @Autowired
    private DfExcelC98bInkBm3andoilConfig01Mapper mapper;

    public int importConfigFromExcel(MultipartFile file,String batchId) {
        log.info("开始读取Excel文件...");
        List<DfExcelC98bInkBm3andoilConfig01> dataList = new ArrayList<>();
        ...
        try {
            ...
            try {
                ...
                // 创建实体对象
                DfExcelC98bInkBm3andoilConfig01 config = new DfExcelC98bInkBm3andoilConfig01();
    ...
    public int batchSaveConfig(List<DfExcelC98bInkBm3andoilConfig01> dataList) {
        if (dataList.isEmpty()) {
            return 0;
        }
        ...
        for (DfExcelC98bInkBm3andoilConfig01 data : dataList) {
            try {
                mapper.insert(data);
                successCount++;
                log.info("==================== 保存配置数据 ====================");
    ...
    private boolean isValidConfigData(DfExcelC98bInkBm3andoilConfig01 data) {
    ...
    // 保留原有的getMergedCellValue和getCellValue方法
