...
import com.biel.qmsgather.mapper.DfExcelC98bInkIr1Config01Mapper;
import com.biel.qmsgather.service.DfExcelC98bInkIr1Config01Service;
...
/**
* @author 96901
* @description 针对表【df_excel_c98b_ink_ir1_config_01】的数据库操作Service实现
* @createDate 2025-02-21 10:03:17
*/
@Service
@Slf4j
public class DfExcelC98bInkIr1Config01ServiceImpl extends ServiceImpl<DfExcelC98bInkIr1Config01Mapper, DfExcelC98bInkIr1Config01>
    implements DfExcelC98bInkIr1Config01Service{


    @Autowired
    private DfExcelC98bInkIr1Config01Mapper mapper;

    public int importConfigFromExcel(MultipartFile file,String batchId) {
        List<DfExcelC98bInkIr1Config01> dataList = new ArrayList<>();
        ZipSecureFile.setMinInflateRatio(0.001);
        String sheetName = "IR1";
        ...
        try {
            ...
            try {
                ...
                DfExcelC98bInkIr1Config01 config = new DfExcelC98bInkIr1Config01();
                ...
                try {
                    ...
                    if (row2 != null) {
                        String modelCode = getMergedCellValue(sheet, 1, 0, row2.getCell(0), evaluator, formatter);
                        config.setModelCode(modelCode);
                        log.info("型号: {}", modelCode);

                        String measuringInstrument = getMergedCellValue(sheet, 1, 1, row2.getCell(1), evaluator, formatter);
                        config.setMeasuringInstrument(measuringInstrument);
                        log.info("测量仪器: {}", measuringInstrument);
                    }
    ...
    public int batchSaveConfig(List<DfExcelC98bInkIr1Config01> dataList) {
        if (dataList.isEmpty()) {
            return 0;
        }
        ...
        for (DfExcelC98bInkIr1Config01 data : dataList) {
            try {
                mapper.insert(data);
                successCount++;
    ...
    private boolean isValidConfigData(DfExcelC98bInkIr1Config01 data) {
