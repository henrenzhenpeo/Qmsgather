...
import com.biel.qmsgather.mapper.DfExcelC98bInkOilConfigMapper;
import com.biel.qmsgather.service.DfExcelC98bInkOilConfigService;
...
/**
* @author 96901
* @description 针对表【df_excel_c98b_ink_oil_config】的数据库操作Service实现
* @createDate 2025-02-19 10:19:26
*/
@Service
@Slf4j
public class DfExcelC98bInkOilConfigServiceImpl extends ServiceImpl<DfExcelC98bInkOilConfigMapper, DfExcelC98bInkOilConfig>
    implements DfExcelC98bInkOilConfigService {
    ...
    public int importOilConfigFromExcel(MultipartFile file) {
        ...
        try {
            ...
            for (int i = 0; i <= 5; i++) {
                ...
                try {
                    DfExcelC98bInkOilConfig config = new DfExcelC98bInkOilConfig();
    ...
    private int batchSaveConfig(List<DfExcelC98bInkOilConfig> configList) {
        ...
        for (DfExcelC98bInkOilConfig config : configList) {
            try {
    ...
    private boolean isValidConfigData(DfExcelC98bInkOilConfig config) {
