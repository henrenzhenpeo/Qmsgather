...
/**
* @author 96901
* @description 针对表【df_excel_c98b_r_corner_groove(C98B线框R角与凹槽相关数据)】的数据库操作Service实现
* @createDate 2025-02-13 11:12:53
*/
@Slf4j
@Service
public class DfExcelC98bRCornerGrooveServiceImpl extends ServiceImpl<DfExcelC98bRCornerGrooveMapper, DfExcelC98bRCornerGroove>
    implements DfExcelC98bRCornerGrooveService{
